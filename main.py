...
def chatbot():
    ...
    #Store conversions in dictionary
    db = {
        'greetings': {
        ...
        'bye': {
            ...
            'responses': [f'See you later, {name}!', f'Bye, {name}!'],  # noqa
        },
        'thankyou': {
        ...
        'bored': {
            ...
            'responses': ['Say goodbye to your boredom and chat with me!'],  # noqa
        },
        'nameask': {
    ...
    elif userinput == 'tell me a joke' or userinput == 'tell me another joke':
    ...
    elif userinput == 'how can i stop you' or userinput == 'how to end conversation?' or userinput == "how to stop you":
        sendBotMsg("By entering 'stop' ")

    elif userinput == 'stop':
        sendBotMsg("See you later...")
        exit(0)
    else:
